...
namespace Players_and_coaches8.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Number,Team,Age,Nationality")] Players players)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Number,Team,Age,Nationality")] Players players)
        {
            if (id != players.Id)
            {
                return NotFound();
